                ...
                <div class="relative flex w-full flex-wrap items-stretch mb-3">
                  <span class="z-10 h-full leading-snug font-normal text-center text-slate-300 absolute bg-transparent rounded text-base items-center justify-center w-8 pl-2 py-3">
                    <svg
                      ...
                      strokeWidth={1.5}
                      stroke="currentColor"
                      className="w-6 h-6 text-primary group-hover:stroke-white"
                    >
                      <path
                        strokeLinecap="round"
                  ...
                  <input
                    ...
                    class="rounded w-full text-gray-800 focus:outline-none focus:border-primary transition duration-500 px-3 pb-3 tracking-widest border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
                  ...
                  <button
                    className="bg-white font-bold py-2 rounded hover:shadow-xl transition duration-200 text-primary hover:bg-light"
                    onClick={sendOTP}
                  >
                    Next
                  </button>
